...
public class UpdatePunchListItemsQuestions {
	static Logger logger = Logger.getLogger(UpdatePunchListItemsQuestions.class.getName());
	public static JSONObject question1(String iosReferences,JSONObject answer){
		try{
			...
			printExceptions(e,"question1");
		}
		return answer;
	}
	
	public static JSONObject question4(String iosPersonResponsible,JSONObject answer){
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
			...
			printExceptions(e,"question4");
		}
		return answer;
	}
	
	public static JSONObject question2(List<String> associatedItems,JSONObject answer){
		...
		try{
			...
			printExceptions(e,"question2");
		}
		return answer;
	}
	
	public static JSONObject question5(String iosClosingDate,JSONObject answer){
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
			...
			printExceptions(e,"question5");
		}
		return answer;
	}
	public static JSONObject question6(String iosAdditionalComments,JSONObject answer){
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
			...
			printExceptions(e,"question6");
		}
		return answer;
	}
	public static JSONObject question7(String iosStatus,JSONObject answer){
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
			...
			printExceptions(e,"question7");
		}
		return answer;
	}
	public static JSONObject question8(String iosHoursSpent,JSONObject answer){
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
			...
			printExceptions(e,"question8");
		}
		return answer;
	}
	public static JSONObject question9(Object iosCritical,JSONObject answer,List<JSONObject> listPossibleAnswers){
		...
		try{
			...
			printExceptions(e,"question9");
		}
		return answer;
	}
	public static JSONObject question0(String iosItemDescription,JSONObject answer){
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
			answerArray = Arrays.asList(iosItemDescription.split("\\s*,\\s*"));
			answer.put("value",answerArray);
		}catch(Exception e){
			printExceptions(e,"question0");
		}
		return answer;
	}

	public static JSONObject question3(String iosCorrectiveAction, JSONObject answer) {
		try{
			List<String> answerArray = (List<String>) answer.get("value");
			answerArray.clear();
	...
	public void createNewNCR(){
		try{
		  ...
		  List<JSONObject> cardListArray = new ArrayList<JSONObject>();
			...
			printExceptions(e,"createNewNCR");
		}
	}
	...
	public static JSONObject getCategoryList(JSONObject jsonRequest) {
		...
		JSONObject sorJson = new JSONObject();
		  try{
			  Object obj = parse.parse(new FileReader("UpdatePunchList.json"));
			  ...
			  for(int j=0;j<listQuestionsObj.size();j++){
				  ...
				  if(questionId.endsWith("Question0")){
					  ...
					  itemDescription = (String) jsonRequest.get("itemDescription");
					  if(null!=itemDescription && !itemDescription.isEmpty()){
						  JSONObject answer = (JSONObject) listQuestions.get("answer");
						  value = (List<String>) answer.get("value");
					  value = Arrays.asList(itemDescription.split("\\s*,\\s*"));
					  answer.put("value",value);
					  listQuestions.put("answer", answer);
					  }
					  ...
					  if(null!=jsonRequest.get("critical")){
						  JSONObject answer = (JSONObject) listQuestions.get("answer");
						  value = (List<String>) answer.get("value");
						  logger.severe("Before isCritical value in new card for update punch list item :");
						  isCritical = jsonRequest.get("critical");
						  logger.severe("isCritical value in new card for update punch list item :" + isCritical);
